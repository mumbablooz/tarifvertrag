export const questionArray = [
    {
        question: "Was ist eine Tarifkommission ?",
        answer: [
    {
        content:["Die Tarifkommission berät die Unternehmen regelmäßig jährlich zu den notwendigen Fahrpreisanpassungen. "],
        isTrue: false
    },
    {
    ...
    {
        question: "Wie entsteht eine Tarifkommission ?",
        answer: [
    {
    ...
    {
        content:["Die Mitglieder der Tarifkommissionen werden durch die Geschäftsführer*innen der Unternehmen auf Vorschlag der jeweiligen Betriebsvorsitzenden berufen. "],
        isTrue: false
    },
    {
        content:["Die Mitglieder der Tarifkommission werden durch den/die Landesfachbereichsleiter*in eingesetzt."],
        isTrue: false
    }
    ]
    }
